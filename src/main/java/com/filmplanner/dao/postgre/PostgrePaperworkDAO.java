...
public class PostgrePaperworkDAO implements PaperworkDAO {
     ...
     */
    @Override
    public Paperwork create(Paperwork paperwork) {
        ...
        try {
            ...
            statement.setLong(4, paperwork.getProject().getId());
    ...
    public static void main(String[] args) {
        ...
        Paperwork[] paperworks = paperworkDAO.findManyByProjectId(project);
